...
public class FragmentChinese extends ListFragment {
	
	ArrayList<StoreInfo> chinese_list = new ArrayList<StoreInfo>();
	/**
	 * Default constructor.
	 */
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		{
			if(MainActivity.all_list.get(i).get_type().equals("1"))
			{
				chinese_list.add(MainActivity.all_list.get(i));
			}
		}
		
		ArrayAdapter<StoreInfo> adapter = new StoreInfoAdapter(getActivity(), R.layout.listview_store, chinese_list);
