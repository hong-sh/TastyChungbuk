...
public class FragmentEtc extends ListFragment {
	
	ArrayList<StoreInfo> etc_list = new ArrayList<StoreInfo>();
	/**
	 * Default constructor.
	 */
	public FragmentEtc() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		{
			if(MainActivity.all_list.get(i).get_type().equals("4"))
			{
				etc_list.add(MainActivity.all_list.get(i));
			}
		}
		
		ArrayAdapter<StoreInfo> adapter = new StoreInfoAdapter(getActivity(), R.layout.listview_store, etc_list);
